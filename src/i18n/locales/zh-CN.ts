const zhCN = {
  ...
  spreads: {
    ...
    unity: {
      name: '万象归一阵', shortName: '万象归一', englishTitle: 'The Unity of All Things',
      readingTime: '起卦流程', cardCount: 18, recommended: '重大决策、长期关系与人生转折',
      description: '以六轮十八张塔罗完成一次严格的三币法起卦。',
      summary: '六轮抽牌将依次生成初爻至上爻，并计算本卦、动爻与变卦。', positions: [],
    },
  },
  drawing: {
    freeTitle: '免费抽牌',
    ...
    unityResultTitle: '万象归一阵 · 起卦结果',
    unityRoundsTitle: '六轮十八张牌',
    unityStructureTitle: '卦象结构',
    unityPrimaryHexagram: '本卦编号',
    unityChangedHexagram: '变卦编号',
    unityMovingLines: '动爻位置',
    unityNoMovingLines: '无',
